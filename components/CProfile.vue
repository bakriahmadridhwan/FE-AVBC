<template>
  <div class="w-full flex flex-col p-4">
    <div v-if="!credentials" class="flex justify-center items-center flex-col">
      <Spinner />
    </div>
    <div v-else class="flex justify-center items-center flex-col">
      ...
      <div class="uppercase text-xs text-gray-700 font-semibold">
        nim : {{ credentials.pengguna_detail.nim }}
      </div>
      <div class="text-gray-500 text-sm">
        {{ credentials.email }}
      </div>
      <div class="w-full my-4 border-b"></div>
      <div v-if="wa.loading" class="flex justify-center items-center">
        <Spinner />
      </div>
      <div v-else>
        <button
